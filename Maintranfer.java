...
public class Maintranfer extends JFrame implements ActionListener {

    JLabel l1, l2, l3, l4, l5, l6, l7, l8, l9, l10, l11, l12, l13;
    JButton b;
    JRadioButton r1, r2, r3, r4;
    JTextField t1, t2, emailField;
    JComboBox<String> c1, c2, c3, c4, c5;
    String formno;

    Maintranfer(String formno) {
        ...
        emailField = new JTextField(); // Include emailField
    ...
    public static void main(String[] args) {
        new Maintranfer("").setVisible(true);
    }
}
